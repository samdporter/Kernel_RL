...
DATASETS: Dict[str, Dict[str, object]] = {
    "spheres": {
        "config": PipelineConfig(
            ...
            do_krl=False,
            do_drl=False,
            rl_iterations_standard=60,
            rl_iterations_kernel=80,
            dtv_iterations=80,
            fwhm=(5.5, 5.5, 5.5),
            psf_kernel_size=5,
            save_suffix="spheres",
...
PIPELINES: Dict[str, Dict[str, object]] = {
    "dtv": {
        ...
        "config_overrides": {"do_drl": True, "do_rl": False, "do_krl": False},
        "kernel_overrides": {},
        "config_grid": {
            "alpha": [0.05, 0.1, 0.2],
            "step_size": [0.5, 1.0],
            "relaxation_eta": [0.01, 0.05],
        },
        "kernel_grid": {},
    },
    "krl": {
        "description": "Kernelised Richardson–Lucy",
        "config_overrides": {"do_krl": True, "do_rl": False, "do_drl": False},
        "kernel_overrides": {"hybrid": False},
        "config_grid": {
            "rl_iterations_kernel": [80, 120],
        },
        "kernel_grid": {
            "sigma_anat": [0.3, 0.6],
            "sigma_dist": [0.6, 1.2],
            "num_neighbours": [3, 5],
            "distance_weighting": [False, True],
        },
    },
    "hkrl": {
        "description": "Hybrid kernelised Richardson–Lucy",
        "config_overrides": {"do_krl": True, "do_rl": False, "do_drl": False},
        "kernel_overrides": {"hybrid": True, "use_mask": True},
        "config_grid": {
            "rl_iterations_kernel": [100],
        },
        "kernel_grid": {
            "sigma_anat": [0.25, 0.45],
            "sigma_dist": [0.6, 0.9],
            "num_neighbours": [5],
            "mask_k": [32, 64],
            "distance_weighting": [True],
